...
public class Example {
    ...
    public static void main(String[] args) throws MalformedURLException, IOException {
        ...
        try {
        	...
        	FatFingers fat = new FatFingers(driver);
        	String xpath = ".//*[@id='MobileUH']/div[2]/ul/li[1]/a/i";
			...
			try {
				...
				//validate we navigated away from this page:
				Thread.sleep(2000);
				driver.findElementByXPath(xpath);
			} catch (Exception e) {
				System.out.println("Great, we navigated away from the current page, as expected.");
			}
        	...
        	try {
        		Thread.sleep(2000);
				driver.findElementByXPath(xpath);
				System.out.println("Great!!!! we passed the Fat Finger test!");
			} catch (Exception e) {
				System.out.println("Fat Fingure failed... Oh No, we navigated away from the page...");
			}
